...
![Figure 1. Geometry of the feedback setup. The laser beam is aligned along the z axis, it determines the size of the feedback region.](assets/quant-ph_0402009v1/important_figure.png)
...
![Figure 3: Early electron beam generation. (a–c) UV photoinjector laser temporal profiles used](assets/2603.15996v1/important_figure.png)
